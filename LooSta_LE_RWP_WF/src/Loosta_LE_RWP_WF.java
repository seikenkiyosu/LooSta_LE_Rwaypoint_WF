...
class Loosta_LE_RWP{
	...
	public static String RandomMethod = "RWP";
	...
	public static String WritingPath = DataPath + "Data_" + RandomMethod + "\\" 
			+ RandomMethod + "_" + r + "R_" + DistanceforInteraction + "DI_" + Gridsize + "GS_" + DataNum + "DN\\";
	...
	//				System.out.println("the number of leaders = " + leadercount);
			...
			try{
		        ...
		        File fileCT = new File(WritingPath + "CT" + "_s=" + svalue + "_n=from" + nfromvalue + "to" + ntovalue + "_RWP" + ".txt");
		        File fileHT = new File(WritingPath + "HT" + "_s=" + svalue + "_n=from" + nfromvalue + "to" + ntovalue + "_RWP" + ".txt");
